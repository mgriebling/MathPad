...
public:
	...
	static void SetDecPoint(int dp);
...
//	static void Write(Preference *w, const char *name, const Complex& x);
	...
	static void ComplexToStr(const Complex& A, char *Str);
...
private:
	...
	static void NumToStr(const Real& A, short Decimal, short Digits, char *Str, char Mode);
};
